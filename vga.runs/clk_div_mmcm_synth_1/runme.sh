...
HD_PWD='D:/Ayush/Xilinx/vga/vga.runs/clk_div_mmcm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_div_mmcm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_div_mmcm.tcl
