...
#
# vga_build.tcl: Tcl script for re-creating project 'vga'
#
# Generated by Vivado on Thu Sep 17 15:33:56 +0530 2026
...
#
# 1. This project restoration tcl script (vga_build.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/Ayush/Xilinx/vga/vga.srcs/sources_1/new/vga.v"
#    "D:/Ayush/Xilinx/vga/vga.srcs/sources_1/ip/clk_div_mmcm/clk_div_mmcm.xci"
#    "D:/Ayush/Xilinx/vga/vga.srcs/sim_1/new/vga_tb.v"
#    "D:/Ayush/Xilinx/vga/vga_tb_behav.wcfg"
#    "D:/Ayush/Xilinx/vga/vga.srcs/utils_1/imports/synth_1/vga.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../vga.srcs/sources_1/new/vga.v"]"\
 "[file normalize "$origin_dir/../vga.srcs/sources_1/ip/clk_div_mmcm/clk_div_mmcm.xci"]"\
 "[file normalize "$origin_dir/../vga.srcs/sim_1/new/vga_tb.v"]"\
 "[file normalize "$origin_dir/../vga_tb_behav.wcfg"]"\
 "[file normalize "$origin_dir/../vga.srcs/utils_1/imports/synth_1/vga.dcp"]"\
  ]
  foreach ifile $files {
...
# Set 'sources_1' fileset file properties for local files
set file "clk_div_mmcm/clk_div_mmcm.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "vga/vga_tb_behav.wcfg"
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7s15ftgb196-1 -flow {Vivado Synthesis 2024} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/vga.dcp" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7s15ftgb196-1 -flow {Vivado Implementation 2024} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
