...
#
# Script generated by Vivado on Wed Aug 05 09:48:50 +0530 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clk_div_mmcm.sh
...
#
# Usage        : clk_div_mmcm.sh
#                clk_div_mmcm.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_div_mmcm.sh [-reset_run]
#                clk_div_mmcm.sh [-reset_log]
#                clk_div_mmcm.sh [-help]
#
...
# script info
echo -e "clk_div_mmcm.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_div_mmcm.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_div_mmcm xil_defaultlib.clk_div_mmcm xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clk_div_mmcm -key {Behavioral:sim_1:Functional:clk_div_mmcm} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clk_div_mmcm.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clk_div_mmcm.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clk_div_mmcm.sh [-help]\n\
Usage: clk_div_mmcm.sh [-step]\n\
Usage: clk_div_mmcm.sh [-lib_map_path]\n\
Usage: clk_div_mmcm.sh [-reset_run]\n\
Usage: clk_div_mmcm.sh [-reset_log]\n\
Usage: clk_div_mmcm.sh [-keep_index]\n\
Usage: clk_div_mmcm.sh [-noclean_files]\n\n\
